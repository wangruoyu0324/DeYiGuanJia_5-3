...
//48:0 打开 49:1 关闭
                    ...
                    if (!result.equals("8A 01 00 11 9A")) {//垃圾柜门已经关闭（包括是否已经打开过门）
                        repeatNum++;
                        if (repeatNum >= 1) {
                            repeatNum = 0;

                            if (myAlertDialog == null)
                                myAlertDialog = new MyAlertDialog(com.chuxinbuer.deyiguanjia.mvp.view.activity.ChooseRefuseKindActivity_Manager.this).builder().setCancelable(false).setCanceledOnTouchOutside(false);
                        ...
                        new Handler().postDelayed(new Runnable() {
                            ...
                            public void run() {
                                ...
                                String code1 = "01 06 00 25 00 00" + CRC16Util.getCrc("01 06 00 25 00 00");
                                String str2 = "";
                                if (code1.contains(" ")) {
                                    str2 = code1.replace(" ", "");
                                }
                        ...
                        new Handler().postDelayed(new Runnable() {
                            ...
                            public void run() {
                                ...
                                String code1 = "02 06 00 25 00 00" + CRC16Util.getCrc("02 06 00 25 00 00");
                                String str2 = "";
                                if (code1.contains(" ")) {
                                    str2 = code1.replace(" ", "");
                                }
                        ...
                        new Handler().postDelayed(new Runnable() {
                            ...
                            public void run() {
                                ...
                                String code1 = "03 06 00 25 00 00" + CRC16Util.getCrc("03 06 00 25 00 00");
                                String str2 = "";
                                if (code1.contains(" ")) {
                                    str2 = code1.replace(" ", "");
                                }
                        ...
                        new Handler().postDelayed(new Runnable() {
                            ...
                            public void run() {
                                ...
                                String code1 = "04 06 00 25 00 00" + CRC16Util.getCrc("04 06 00 25 00 00");
                                String str2 = "";
                                if (code1.contains(" ")) {
                                    str2 = code1.replace(" ", "");
                                }
                        ...
                        new Handler().postDelayed(new Runnable() {
                            ...
                            public void run() {
                                ...
                                String code1 = "05 06 00 25 00 00" + CRC16Util.getCrc("05 06 00 25 00 00");
                                String str2 = "";
                                if (code1.contains(" ")) {
                                    str2 = code1.replace(" ", "");
                                }
