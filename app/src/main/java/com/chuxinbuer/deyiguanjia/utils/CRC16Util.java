...
public class CRC16Util {
    public static void main(String[] args) {
        String str16 = "1F 03  002A0001";
        System.out.println(getCrc(str16));
    }
     ...
     * @return
     */
    public static String getCrc(String res) {
        if (res.contains(" ")) {
            res = res.replace(" ", "");
        }
        String format = String.format("%04x", calcCrc16(str2HexByte(res)));
        String substring = format.substring(0, 2);
        String substring1 = format.substring(2, 4);
//        Log.i("BLUEDATA", "crc ---- : " + substring + "  " + substring1);
        return substring1.concat(" ").concat(substring).concat(" ").toUpperCase();
    }
