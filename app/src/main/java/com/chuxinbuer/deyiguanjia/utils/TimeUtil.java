...
public class TimeUtil {
    ...
    public final static String FORMAT_STRING = "yyyyMMddHHmmss";
    public final static String FORMAT_DATE = "yyyy-MM-dd";
    public final static String FORMAT_BUILDTIME = "yyyy-MM";
    public final static String FORMAT_DATE4 = "yyyy年MM月dd日";
    public final static String FORMAT_DATE2 = "yyyy/MM/dd";
    public final static String FORMAT_TIME = "HH:mm";
    public final static String FORMAT_TIME_DOT = "yyyy.MM.dd";
    public final static String FORMAT_TIME_DOT_FULL = "yyyy.MM.dd HH:mm:ss";
    ...
    public final static String FORMAT_DATE_TIME2 = "yyyy年MM月dd日  HH:mm";
    ...
    public static String longToString(long currentTime, String formatType) {
        String strTime = "";
        if (formatType == null || formatType.trim().equals("")) {
    ...
    public static String getTime_year(long time) {
    ...
    public static String getIntegralTime(long timesamp) {
        String result = "";
        SimpleDateFormat sdf = new SimpleDateFormat("dd");
        Date today = new Date(System.currentTimeMillis());
