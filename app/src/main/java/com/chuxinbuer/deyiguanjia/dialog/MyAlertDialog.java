package com.chuxinbuer.deyiguanjia.dialog;
...
public class MyAlertDialog {
    ...
    public MyAlertDialog builder() {
        ...
        mWithDrawRule = (TextView) view.findViewById(R.id.mWithDrawRule);
        ...
        // 定义Dialog布局和参数
        dialog = new Dialog(context, R.style.AlphaDialogStyle);
    ...
    public MyAlertDialog setEditText_Real(String msg) {
    ...
    public MyAlertDialog setDissDialog(boolean isdissmiss) {
        isDismiss = isdissmiss;
        return this;
    }
    ...
    private void setLayout() {
        ...
        if (!showPosBtn && !showNegBtn) {
            ...
            btn_pos.setBackgroundResource(R.drawable.shape_white_actionbar);
            btn_pos.setOnClickListener(new OnClickListener() {
                @Override
                public void onClick(View v) {
                    if (showEditText) {
                        if (Common.empty(getResult())) {
                            ToastUtil.showShort("请输入手机号码后四位！");
                            return;
                        }
                    }
                    dialog.dismiss();
...
//dialog.show
    ...
    public void setTextLineSpacing() {
        txt_msg.setLineSpacing(-6, 1);
    }

    public void showRule() {
        mWithDrawRule.setVisibility(View.VISIBLE);
    }
}
